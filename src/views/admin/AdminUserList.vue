...
export default defineComponent({
  ...
  data() {
    return {
      ...
      strings: {
        title: t('forum', 'Account management'),
        subtitle: t('forum', 'Manage forum accounts, roles and permissions'),
        loading: t('forum', 'Loading accounts …'),
        errorTitle: t('forum', 'Error loading accounts'),
        retry: t('forum', 'Retry'),
        ...
        editRolesTitle: t('forum', 'Edit account roles'),
        save: t('forum', 'Save'),
