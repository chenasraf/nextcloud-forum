OC.L10N.register(
    ...
    "Create discussions, share ideas and collaborate with your community directly in Nextcloud.\n\n**⚠️ Early Development Notice:**\nThis app is in early stages of development. While functional, you may encounter bugs or incomplete features. Please report any issues on GitHub and consider backing up your data regularly.\n\n**Key features:**\n- **Thread-based Discussions** - Create and reply to organized discussion threads\n- **Category Organization** - Structure your forum with customizable categories and headers\n- **Rich Text Formatting** - Use BBCode for formatting posts with bold, italic, links, images, code blocks and more\n- **File Attachments** - Attach files from your Nextcloud storage to posts\n- **Post Reactions** - React to posts with emoji reactions\n- **Read/Unread Tracking** - Keep track of which threads you've read\n- **Search** - Find discussions quickly with built-in search\n- **User Profiles** - View user post history and statistics\n- **Role-Based Permissions** - Control access and moderation with flexible roles\n- **Guest Access**: Optional public access for unauthenticated users with configurable permissions\n- **Admin Tools** - Manage categories, roles, BBCodes and forum settings\n- **Moderation Tools** - Pin, lock and manage threads and posts\n\n**Perfect for:**\n- Team discussions and collaboration\n- Community forums\n- Support channels\n- Knowledge bases\n- Project discussions\n- Internal communication\n\nThe forum integrates seamlessly with your Nextcloud instance, using your existing users and groups for authentication and access control." : "Δημιουργήστε συζητήσεις, μοιραστείτε ιδέες και συνεργαστείτε με την κοινότητά σας απευθείας στο Nextcloud.\n\n**⚠️ Σημείωση Πρώιμης Ανάπτυξης:**\nΑυτή η εφαρμογή βρίσκεται σε πρώιμα στάδια ανάπτυξης. Παρόλο που είναι λειτουργική, ενδέχεται να συναντήσετε σφάλματα ή ημιτελή χαρακτηριστικά. Παρακαλούμε αναφέρετε τυχόν προβλήματα στο GitHub και φροντίστε για την τακτική δημιουργία αντιγράφων ασφαλείας των δεδομένων σας.\n\n**Βασικά χαρακτηριστικά:**\n- **Συζητήσεις βάσει θεμάτων** - Δημιουργήστε και απαντήστε σε οργανωμένα θέματα συζήτησης\n- **Οργάνωση Κατηγοριών** - Δομήστε το φόρουμ σας με προσαρμόσιμες κατηγορίες και κεφαλίδες\n- **Μορφοποίηση Εμπλουτισμένου Κειμένου** - Χρησιμοποιήστε BBCode για μορφοποίηση δημοσιεύσεων με έντονη γραφή, πλάγια, συνδέσμους, εικόνες, μπλοκ κώδικα και άλλα\n- **Συνημμένα Αρχεία** - Επισυνάψτε αρχεία από τον αποθηκευτικό χώρο του Nextcloud σας στις δημοσιεύσεις\n- **Αντιδράσεις Δημοσιεύσεων** - Αντιδράστε σε δημοσιεύσεις με αντιδράσεις emoji\n- **Παρακολούθηση Αναγνωσμένων/Μη Αναγνωσμένων** - Παρακολουθήστε ποια θέματα έχετε διαβάσει\n- **Αναζήτηση** - Βρείτε συζητήσεις γρήγορα με την ενσωματωμένη αναζήτηση\n- **Προφίλ Χρηστών** - Δείτε το ιστορικό δημοσιεύσεων και τα στατιστικά των χρηστών\n- **Δικαιώματα βάσει Ρόλων** - Ελέγξτε την πρόσβαση και τη συντονιστική δραστηριότητα με ευέλικτους ρόλους\n- **Πρόσβαση Επισκεπτών**: Προαιρετική δημόσια πρόσβαση για μη ταυτοποιημένους χρήστες με ρυθμιζόμενα δικαιώματα\n- **Εργαλεία Διαχειριστή** - Διαχειριστείτε κατηγορίες, ρόλους, BBCode και ρυθμίσεις φόρουμ\n- **Εργαλεία Συντονισμού** - Καρφιτσώστε, κλειδώστε και διαχειριστείτε θέματα και δημοσιεύσεις\n\n**Ιδανικό για:**\n- Συζητήσεις ομάδας και συνεργασία\n- Φόρουμ κοινότητας\n- Κανάλια υποστήριξης\n- Βάσεις γνώσεων\n- Συζητήσεις έργων (projects)\n- Εσωτερική επικοινωνία\n\nΤο φόρουμ ενσωματώνεται απρόσκοπτα στην εγκατάσταση του Nextcloud σας, χρησιμοποιώντας τους υπάρχοντες χρήστες και ομάδες για την ταυτοποίηση και τον έλεγχο πρόσβασης.",
    ...
    "Roles that can view" : "Ρόλοι με δυνατότητα προβολής",
    ...
    "Roles that can moderate" : "Ρόλοι με δυνατότητα συντονισμού",
