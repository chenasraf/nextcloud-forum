OC.L10N.register(
    ...
    "Run the repair database initial data command to restore default forum data (roles, categories, permissions, BBCodes). This is safe to run multiple times as it will skip data that already exists." : "執行修復資料庫初始資料指令，以還原預設的論壇資料（角色、分類、權限、BBCode）。此操作可安全重複執行，系統會自動略過已存在的資料。",
