OC.L10N.register(
    ...
    "Failed to permanently delete reply" : "Não foi possível excluir definitivamente a resposta",
    "Failed to restore thread" : "Falha ao restaurar o fio",
    "Failed to restore reply" : "Falha ao restaurar a resposta",
    "_Permanently delete %n selected thread and all its replies? This cannot be undone._::_Permanently delete %n selected threads and all their replies? This cannot be undone._" : ["Deseja excluir definitivamente o %n fio selecionado e todas as respostas a ele? Essa ação não pode ser revertida.","Deseja excluir definitivamente os %n de fios selecionados e todas as respostas a eles? Essa ação não pode ser revertida.","Deseja excluir definitivamente os %n fios selecionados e todas as respostas a eles? Essa ação não pode ser revertida."],
    "_Permanently delete %n selected reply? This cannot be undone._::_Permanently delete %n selected replies? This cannot be undone._" : ["Deseja excluir definitivamente a %n resposta selecionada? Essa ação não pode ser revertida.","Deseja excluir definitivamente as %n de respostas selecionadas? Essa ação não pode ser revertida.","Deseja excluir definitivamente as %n respostas selecionadas? Essa ação não pode ser revertida."],
    "_Deleted %n item; the rest could not be removed._::_Deleted %n items; the rest could not be removed._" : ["Excluí %n item; os demais não puderam ser removidos.","Excluí %n de itens; os demais não puderam ser removidos.","Excluí %n itens; os demais não puderam ser removidos."],
