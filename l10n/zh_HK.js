OC.L10N.register(
    ...
    "Upload file to Nextcloud (choose destination)" : "上載檔案至 Nextcloud（選擇目的地）",
    ...
    "Select upload destination" : "選擇上載目的地",
    "User not authenticated" : "使用者尚未驗證身份",
    "Threads" : "討論串",
    "Replies" : "回覆",
    ...
    "Pick a folder …" : "選擇資料夾…",
    "Files attached to threads or replies will be uploaded to this directory in your Nextcloud files. The path resolves to your own files; other users will see the same folder at its location in their own files." : "附加至主題或回覆的檔案將上載至你 Nextcloud 檔案中的此目錄。此路徑會對應至你自己的檔案；其他使用者會在其自己的檔案中相同位置看到同一資料夾。",
    "Upload behavior" : "上載行為",
    "Always upload to chosen directory" : "一律上載至已選目錄",
    "Always prompt for upload location" : "每次均提示選擇上載位置",
    "Whether attachment uploads use your configured directory or ask you to pick a destination each time" : "附件上載時使用你已設定的目錄，還是每次要求你選擇目的地",
    "Use category-specific paths when available" : "可用時使用分類專屬路徑",
    "When a category has its own attachments folder configured, uploads in that category go there instead of your default upload directory" : "當分類已設定其專屬附件資料夾時，該分類中的上載項目會存放於該處，而非你的預設上載目錄",
    "Browse" : "瀏覽",
    ...
    "Attachments" : "附件",
    "Configure where uploads in this category are stored" : "設定此分類中的上載項目儲存位置",
    "Use default attachments path" : "使用預設附件路徑",
    "Uploads in this category land in each user's personal upload directory" : "此分類中的上載項目會儲存在各使用者的個人上載目錄",
    "Use category-specific attachment path" : "使用分類專屬附件路徑",
    "Category attachments folder" : "分類附件資料夾",
    "The shown path is resolved to your own files. Other admins will see the same folder at the location it appears in their own files." : "顯示的路徑會對應至你自己的檔案。其他管理員會在其自己的檔案中相同位置看到同一資料夾。",
    "This folder must be accessible to every user who uploads in this category. If a user cannot write to it, their upload will fall back to their personal default path." : "此資料夾必須讓所有於此分類上載的使用者存取。如使用者無法寫入，其上載項目將退回至其個人預設路徑。",
    "Pick a folder" : "選擇資料夾",
    ...
    "Configure how thread and reply counts are calculated for categories" : "設定分類中的主題及回覆數量計算方式",
    "Count subcategory threads/replies in category counts" : "於分類計數中包含子分類的主題／回覆數量",
    "When enabled, category cards will show total threads/replies from all subcategories combined. When disabled, only the threads/replies from the category itself will be counted." : "啟用後，分類卡片會顯示所有子分類合計的主題／回覆總數。停用後，只會計算該分類本身的主題／回覆數量。",
    ...
    "Newest first" : "最新先",
    "Oldest first" : "最舊先",
    "Permanently delete this thread and all its replies? This cannot be undone." : "永久刪除此討論串及其所有回覆？此操作無法復原。",
    "Permanently delete this reply? This cannot be undone." : "永久刪除此回覆？此操作無法復原。",
    "Failed to permanently delete thread" : "無法永久刪除討論串",
    "Failed to permanently delete reply" : "無法永久刪除回覆",
    ...
    "Failed to permanently delete the selected items" : "無法永久刪除所選項目",
    "Create role" : "建立角色",
    "Edit role" : "編輯角色",
