OC.L10N.register(
    ...
    "Files attached to threads or replies will be uploaded to this directory in your Nextcloud files. The path resolves to your own files; other users will see the same folder at its location in their own files." : "Dateien, die an Themen oder Antworten angehängt werden, werden in dieses Verzeichnis innerhalb Ihrer Nextcloud-Dateien hochgeladen. Der Pfad verweist auf Ihre eigenen Dateien; andere Benutzer sehen denselben Ordner an der entsprechenden Stelle in ihren eigenen Dateien.",
    ...
    "Whether attachment uploads use your configured directory or ask you to pick a destination each time" : "Ob beim Hochladen von Anhängen das eingerichtete Verzeichnis verwendet wird, oder jedes Mal ein Zielort ausgewählt werden muss",
    "Use category-specific paths when available" : "Sofern verfügbar, kategoriespezifische Pfade verwenden ",
    "When a category has its own attachments folder configured, uploads in that category go there instead of your default upload directory" : "Wenn für eine Kategorie ein eigener Anhangsordner konfiguriert ist, gelangen Uploads in dieser Kategorie dorthin – anstatt in das Standard-Upload-Verzeichnis",
    "Browse" : "Durchsuchen",
    ...
    "Uploads in this category land in each user's personal upload directory" : "Uploads in dieser Kategorie landen im persönlichen Upload-Verzeichnis eines jeden Benutzers",
    ...
    "Category counts" : "Kategorienanzahl",
    "Configure how thread and reply counts are calculated for categories" : "Einstellen, wie Themen- und Antwortzahlen für Kategorien berechnet werden",
    "Count subcategory threads/replies in category counts" : "Themen/Antworten der Unterkategorie in der Kategorienanzahl mitzählen",
    "When enabled, category cards will show total threads/replies from all subcategories combined. When disabled, only the threads/replies from the category itself will be counted." : "Wenn diese Option aktiviert ist, werden auf Kategoriekarten die Gesamtzahl der Themen/Antworten aus allen Unterkategorien angezeigt. Wenn deaktiviert, werden nur die Themen/Antworten in der Kategorie selbst gezählt.",
    ...
    "Permanently delete this thread and all its replies? This cannot be undone." : "Soll dieser Thread und alle seine Antworten endgültig gelöscht werden? Dies kann nicht rückgängig gemacht werden.",
    "Permanently delete this reply? This cannot be undone." : "Diese Antwort endgültig löschen? Dies kann nicht rückgängig gemacht werden.",
    "Failed to permanently delete thread" : "Thread konnte nicht endgültig gelöscht werden",
    "Failed to permanently delete reply" : "Antwort konnte nicht endgültig gelöscht werden",
    ...
    "_Permanently delete %n selected thread and all its replies? This cannot be undone._::_Permanently delete %n selected threads and all their replies? This cannot be undone._" : ["%n ausgewählter Thread und alle dazugehörigen Antworten endgültig löschen? Dies kann nicht rückgängig gemacht werden.","%n ausgewählte Threads und alle dazugehörigen Antworten endgültig löschen? Dies kann nicht rückgängig gemacht werden."],
    "_Permanently delete %n selected reply? This cannot be undone._::_Permanently delete %n selected replies? This cannot be undone._" : ["%n ausgewählte Antwort endgültig löschen? Dies kann nicht rückgängig gemacht werden.","%n ausgewählte Antworten endgültig löschen? Dies kann nicht rückgängig gemacht werden."],
    "_Deleted %n item; the rest could not be removed._::_Deleted %n items; the rest could not be removed._" : ["%n Element wurde gelöscht; die restlichen konnten nicht entfernt werden.","%n Elemente wurden gelöscht; die restlichen konnten nicht entfernt werden."],
    "_Permanently deleted %n item._::_Permanently deleted %n items._" : ["%n Element wurde endgültig gelöscht.","%n Elemente wurden endgültig gelöscht."],
    "Failed to permanently delete the selected items" : "Die ausgewählten Elemente konnten nicht endgültig gelöscht werden.",
