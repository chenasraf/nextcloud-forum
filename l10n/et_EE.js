OC.L10N.register(
    ...
    "Back to {category}" : "Tagasi siia kategooriasse: {category}",
    "Reply" : "Vasta",
    ...
    "Permanently delete this thread and all its replies? This cannot be undone." : "Kas kustutad selle jutulõnga koos kõikide tema vastustega lõplikult? Seda tegevust ei saa tagasi pöörata.",
    "Permanently delete this reply? This cannot be undone." : "Kas kustutad selle vastuse lõplikult? Seda tegevust ei saa tagasi pöörata.",
    "Failed to permanently delete thread" : "Jutulõnga lõplik kustutamine ei õnnestunud",
    "Failed to permanently delete reply" : "Vastuse lõplik kustutamine ei õnnestunud",
    "Failed to restore thread" : "Jutulõnga taastamine ei õnnestunud",
    "Failed to restore reply" : "Vastuse taastamine ei õnnestunud",
    "_Permanently delete %n selected thread and all its replies? This cannot be undone._::_Permanently delete %n selected threads and all their replies? This cannot be undone._" : ["Kas kustutad %n valitud jutulõnga koos kõikide tema vastustega lõplikult? Seda tegevust ei saa tagasi pöörata.","Kas kustutad %n valitud jutulõnga koos kõikide nende vastustega lõplikult? Seda tegevust ei saa tagasi pöörata."],
    "_Permanently delete %n selected reply? This cannot be undone._::_Permanently delete %n selected replies? This cannot be undone._" : ["Kas kustutad %n valitud vastuse lõplikult? Seda tegevust ei saa tagasi pöörata.","Kas kustutad %n valitud vastust lõplikult? Seda tegevust ei saa tagasi pöörata."],
    "_Deleted %n item; the rest could not be removed._::_Deleted %n items; the rest could not be removed._" : ["%n objekt on kustutatud ja ülejäänute kustutamine ei õnnestunud.","%n objekti on kustutatud ja ülejäänute kustutamine ei õnnestunud."],
    "_Permanently deleted %n item._::_Permanently deleted %n items._" : ["%n objekt on lõplikult kustutatud.","%n objekti on lõplikult kustutatud."],
    "Failed to permanently delete the selected items" : "Valitud objektide lõplik kustutamine ei õnnestunud",
