OC.L10N.register(
    ...
    "Create discussions, share ideas and collaborate with your community directly in Nextcloud.\n\n**⚠️ Early Development Notice:**\nThis app is in early stages of development. While functional, you may encounter bugs or incomplete features. Please report any issues on GitHub and consider backing up your data regularly.\n\n**Key features:**\n- **Thread-based Discussions** - Create and reply to organized discussion threads\n- **Category Organization** - Structure your forum with customizable categories and headers\n- **Rich Text Formatting** - Use BBCode for formatting posts with bold, italic, links, images, code blocks and more\n- **File Attachments** - Attach files from your Nextcloud storage to posts\n- **Post Reactions** - React to posts with emoji reactions\n- **Read/Unread Tracking** - Keep track of which threads you've read\n- **Search** - Find discussions quickly with built-in search\n- **User Profiles** - View user post history and statistics\n- **Role-Based Permissions** - Control access and moderation with flexible roles\n- **Guest Access**: Optional public access for unauthenticated users with configurable permissions\n- **Admin Tools** - Manage categories, roles, BBCodes and forum settings\n- **Moderation Tools** - Pin, lock and manage threads and posts\n\n**Perfect for:**\n- Team discussions and collaboration\n- Community forums\n- Support channels\n- Knowledge bases\n- Project discussions\n- Internal communication\n\nThe forum integrates seamlessly with your Nextcloud instance, using your existing users and groups for authentication and access control." : "Diskussionen starten, Ideen austauschen und direkt in Nextcloud mit der Community zusammenarbeiten.**⚠️ Hinweis zur frühen Entwicklungsphase:** Diese App befindet sich in einer frühen Entwicklungsphase. Sie ist zwar funktionsfähig, es können jedoch Fehler oder unvollständige Funktionen auftreten. Bitte melden Sie alle Probleme auf GitHub und erstellen Sie regelmäßig Backups Ihrer Daten.**Hauptfunktionen:**- **Themenbasierte Diskussionen** – Organisierte Diskussionsthemen erstellen und beantworten- **Kategorieorganisation** – Das Forum mit anpassbaren Kategorien und Überschriften strukturieren.- **Rich-Text-Formatierung** – BBCode verwenden, um Beiträge mit Fettdruck, Kursivschrift, Links, Bildern, Codeblöcken und mehr zu formatieren.- **Dateianhänge** – Dateien aus dem Nextcloud-Speicher an Beiträge anhängen.- **Reaktionen auf Beiträge** – Mit Emojis auf Beiträge reagieren.- **Lese-/Ungelesen-Status** – Den Überblick darüber behalten, welche Themen bereits gelesen wurden.- **Suche** – Diskussionen schnell mit der integrierten Suche finden.- **Benutzerprofile** – Den Beitragsverlauf und die Statistiken der Benutzer ansehen.- **Rollenbasierte Berechtigungen** – Den Zugriff und die Moderation mit flexiblen Rollen steuern.- **Gastzugriff**: Optionaler öffentlicher Zugriff für nicht authentifizierte Benutzer mit konfigurierbaren Berechtigungen.- **Admin-Tools** – Kategorien, Rollen, BBCodes und Forumseinstellungen verwalten.- **Moderations-Tools** – Themen und Beiträge anheften, sperren und verwalten.**Perfekt für:**- Teamdiskussionen und Zusammenarbeit- Community-Foren- Supportkanäle- Wissensdatenbanken- Projektdiskussionen- Interne KommunikationDas Forum integriert sich nahtlos in die Nextcloud-Instanz und nutzt die bestehenden Benutzer und Gruppen für die Anmeldung und die Zugriffskontrolle.",
    "Loading …" : "Lade …",
    "Search" : "Suche",
    "Home" : "Startseite",
