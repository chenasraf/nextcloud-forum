OC.L10N.register(
    ...
    "These BBCodes are available by default." : "Esses códigos BBCode estão disponíveis por padrão.",
    ...
    "_Showing %n thread_::_Showing %n threads_" : ["Exibindo %n fio","Exibindo %n de fios","Exibindo %n fios"],
    ...
    "No threads" : "Sem fios",
    "This user has not created any threads yet" : "Este usuário ainda não criou nenhum tópico",
    "No replies" : "Sem respostas",
    "This user has not posted any replies yet" : "Este usuário ainda não postou nenhuma resposta",
    ...
    "Search in posts" : "Pesquisar nas postagens",
    ...
    "Use the search box above to find threads and posts" : "Use a caixa de pesquisa acima para encontrar tópicos e publicações",
    ...
    "_%n post found_::_%n posts found_" : ["%n postagem encontrada","%n de postagens encontradas","%n postagens encontradas"],
    ...
    "No posts yet" : "Ainda sem postagens",
    "Be the first to post in this thread." : "Seja o primeiro a postar neste fio.",
    "by" : "por",
    "This thread is locked. Only moderators can post replies." : "O fio está trancado. Somente moderadores podem postar respostas.",
    ...
    "_Showing %n post_::_Showing %n posts_" : ["Exibindo %n postagem","Exibindo %n de postagens","Exibindo %n postagens"],
    ...
    "Failed to load posts" : "Falha ao carregar postagens",
    "Post updated" : "Postagem atualizada",
    "Failed to update post" : "Falha ao atualizar a postagem",
    "Thread deleted" : "Fio excluído",
    "Post deleted" : "Postagem excluída",
    "Failed to delete post" : "Falha ao excluir a postagem",
    ...
    "Upload directory" : "Pasta de upload",
    ...
    "Manage custom BBCode tags for post formatting" : "Gerencie etiquetas BBCode personalizadas para formatação de postagens",
