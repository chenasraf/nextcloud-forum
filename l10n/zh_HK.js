OC.L10N.register(
    ...
    "Repair Seeds" : "修復種子資料（Repair Seeds）",
    "Run the repair seeds command to restore default forum data (roles, categories, permissions, BBCodes). This is safe to run multiple times as it will skip data that already exists." : "執行「修復種子資料」指令，以還原論壇的預設資料，包括 **角色、分類、權限及 BBCode**。此操作可 安全地重複執行；系統會自動略過已存在的資料，不會重複建立或覆寫。",
    ...
    "No replies" : "沒有回覆",
    "This user has not written any replies yet" : "此用戶尚未發表任何回覆",
